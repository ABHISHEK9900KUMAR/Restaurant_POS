...
const MENU = [
  ...
  { id: 'm2',  category: 'Veg Starters',     categoryHi: 'वेज स्टार्टर',      name: 'Paneer Chilly (Full)',       nameHi: 'पनीर चिली (फुल)',           price: 200, emoji: '🧀', popular: true,  tags: ['veg'],     nutrition: { calories: 420, protein: 24, carbs: 30, fat: 24, ingredients: ['Paneer', 'Capsicum', 'Onion', 'Soy Sauce', 'Garlic', 'Green Chilli'] } },
  ...
  { id: 'm4',  category: 'Veg Starters',     categoryHi: 'वेज स्टार्टर',      name: 'Paneer Manchurian (Full)',   nameHi: 'पनीर मंचूरियन (फुल)',       price: 200, emoji: '🥘', popular: false, tags: ['veg'],     nutrition: { calories: 440, protein: 22, carbs: 36, fat: 26, ingredients: ['Paneer', 'Garlic', 'Ginger', 'Soy Sauce', 'Spring Onion', 'Cornstarch'] } },
  ...
  { id: 'm6',  category: 'Veg Starters',     categoryHi: 'वेज स्टार्टर',      name: 'Paneer Pepper Dry (Full)',   nameHi: 'पनीर पेप्पर ड्राई (फुल)',   price: 240, emoji: '🌶️', popular: false, tags: ['veg'],     nutrition: { calories: 460, protein: 24, carbs: 28, fat: 30, ingredients: ['Paneer', 'Black Pepper', 'Capsicum', 'Onion', 'Garlic', 'Soy Sauce'] } },
  ...
  { id: 'm8',  category: 'Veg Starters',     categoryHi: 'वेज स्टार्टर',      name: 'Paneer 65 (Full)',           nameHi: 'पनीर 65 (फुल)',             price: 240, emoji: '🧀', popular: false, tags: ['veg'],     nutrition: { calories: 500, protein: 26, carbs: 32, fat: 32, ingredients: ['Paneer', 'Yogurt', 'Chilli', 'Curry Leaves', 'Garlic', 'Cornstarch'] } },
  { id: 'm9',  category: 'Veg Starters',     categoryHi: 'वेज स्टार्टर',      name: 'Mushroom Chilly (Half)',     nameHi: 'मशरूम चिली (हाफ)',          price: 100, emoji: '🍄', popular: false, tags: ['veg'],     nutrition: { calories: 150, protein:  6, carbs: 18, fat:  6, ingredients: ['Mushroom', 'Capsicum', 'Onion', 'Soy Sauce', 'Garlic', 'Chilli'] } },
  { id: 'm10', category: 'Veg Starters',     categoryHi: 'वेज स्टार्टर',      name: 'Mushroom Chilly (Full)',     nameHi: 'मशरूम चिली (फुल)',          price: 200, emoji: '🍄', popular: false, tags: ['veg'],     nutrition: { calories: 300, protein: 12, carbs: 36, fat: 12, ingredients: ['Mushroom', 'Capsicum', 'Onion', 'Soy Sauce', 'Garlic', 'Chilli'] } },
  { id: 'm11', category: 'Veg Starters',     categoryHi: 'वेज स्टार्टर',      name: 'Mushroom Manchurian (Half)', nameHi: 'मशरूम मंचूरियन (हाफ)',      price: 100, emoji: '🍄', popular: false, tags: ['veg'],     nutrition: { calories: 160, protein:  6, carbs: 20, fat:  7, ingredients: ['Mushroom', 'Garlic', 'Ginger', 'Soy Sauce', 'Spring Onion', 'Cornstarch'] } },
  { id: 'm12', category: 'Veg Starters',     categoryHi: 'वेज स्टार्टर',      name: 'Mushroom Manchurian (Full)', nameHi: 'मशरूम मंचूरियन (फुल)',      price: 200, emoji: '🍄', popular: false, tags: ['veg'],     nutrition: { calories: 320, protein: 12, carbs: 40, fat: 14, ingredients: ['Mushroom', 'Garlic', 'Ginger', 'Soy Sauce', 'Spring Onion', 'Cornstarch'] } },

  // ─── Non-Veg Starters ───
  { id: 'm13', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Chilly Chicken (Half)',      nameHi: 'चिली चिकन (हाफ)',           price: 100, emoji: '🍗', popular: true,  tags: ['non-veg'], nutrition: { calories: 190, protein: 18, carbs: 10, fat:  9, ingredients: ['Chicken', 'Capsicum', 'Onion', 'Soy Sauce', 'Garlic', 'Green Chilli'] } },
  { id: 'm14', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Chilly Chicken (Full)',      nameHi: 'चिली चिकन (फुल)',           price: 200, emoji: '🍗', popular: true,  tags: ['non-veg'], nutrition: { calories: 380, protein: 36, carbs: 20, fat: 18, ingredients: ['Chicken', 'Capsicum', 'Onion', 'Soy Sauce', 'Garlic', 'Green Chilli'] } },
  { id: 'm15', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Chicken Manchurian (Half)',  nameHi: 'चिकन मंचूरियन (हाफ)',       price: 100, emoji: '🍜', popular: false, tags: ['non-veg'], nutrition: { calories: 180, protein: 17, carbs: 12, fat:  8, ingredients: ['Chicken', 'Garlic', 'Ginger', 'Soy Sauce', 'Spring Onion', 'Cornstarch'] } },
  { id: 'm16', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Chicken Manchurian (Full)',  nameHi: 'चिकन मंचूरियन (फुल)',       price: 200, emoji: '🍜', popular: false, tags: ['non-veg'], nutrition: { calories: 360, protein: 34, carbs: 24, fat: 16, ingredients: ['Chicken', 'Garlic', 'Ginger', 'Soy Sauce', 'Spring Onion', 'Cornstarch'] } },
  { id: 'm17', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Chicken 65 (Half)',          nameHi: 'चिकन 65 (हाफ)',             price: 120, emoji: '🍗', popular: true,  tags: ['non-veg'], nutrition: { calories: 210, protein: 20, carbs: 12, fat: 10, ingredients: ['Chicken', 'Yogurt', 'Chilli', 'Curry Leaves', 'Garlic', 'Cornstarch'] } },
  { id: 'm18', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Chicken 65 (Full)',          nameHi: 'चिकन 65 (फुल)',             price: 240, emoji: '🍗', popular: true,  tags: ['non-veg'], nutrition: { calories: 420, protein: 40, carbs: 24, fat: 20, ingredients: ['Chicken', 'Yogurt', 'Chilli', 'Curry Leaves', 'Garlic', 'Cornstarch'] } },
  { id: 'm19', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Pepper Chicken (Half)',      nameHi: 'पेप्पर चिकन (हाफ)',         price: 120, emoji: '🌶️', popular: false, tags: ['non-veg'], nutrition: { calories: 200, protein: 19, carbs:  8, fat: 11, ingredients: ['Chicken', 'Black Pepper', 'Onion', 'Garlic', 'Capsicum', 'Soy Sauce'] } },
  { id: 'm20', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Pepper Chicken (Full)',      nameHi: 'पेप्पर चिकन (फुल)',         price: 240, emoji: '🌶️', popular: false, tags: ['non-veg'], nutrition: { calories: 400, protein: 38, carbs: 16, fat: 22, ingredients: ['Chicken', 'Black Pepper', 'Onion', 'Garlic', 'Capsicum', 'Soy Sauce'] } },
  { id: 'm21', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Lemon Chicken (Half)',       nameHi: 'लेमन चिकन (हाफ)',           price: 120, emoji: '🍋', popular: false, tags: ['non-veg'], nutrition: { calories: 190, protein: 19, carbs:  9, fat:  9, ingredients: ['Chicken', 'Lemon Juice', 'Onion', 'Garlic', 'Ginger', 'Capsicum'] } },
  { id: 'm22', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Lemon Chicken (Full)',       nameHi: 'लेमन चिकन (फुल)',           price: 240, emoji: '🍋', popular: false, tags: ['non-veg'], nutrition: { calories: 380, protein: 38, carbs: 18, fat: 18, ingredients: ['Chicken', 'Lemon Juice', 'Onion', 'Garlic', 'Ginger', 'Capsicum'] } },
  { id: 'm23', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Dry Chicken (2Pc)',          nameHi: 'ड्राई चिकन (2 पीस)',        price: 109, emoji: '🍖', popular: false, tags: ['non-veg'], nutrition: { calories: 180, protein: 22, carbs:  4, fat:  9, ingredients: ['Chicken', 'Spices', 'Onion', 'Ginger', 'Garlic', 'Chilli'] } },
  { id: 'm24', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Dry Chicken (4Pc)',          nameHi: 'ड्राई चिकन (4 पीस)',        price: 199, emoji: '🍖', popular: true,  tags: ['non-veg'], nutrition: { calories: 360, protein: 44, carbs:  8, fat: 18, ingredients: ['Chicken', 'Spices', 'Onion', 'Ginger', 'Garlic', 'Chilli'] } },
  { id: 'm25', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Dry Chicken (8Pc)',          nameHi: 'ड्राई चिकन (8 पीस)',        price: 389, emoji: '🍖', popular: false, tags: ['non-veg'], nutrition: { calories: 720, protein: 88, carbs: 16, fat: 36, ingredients: ['Chicken', 'Spices', 'Onion', 'Ginger', 'Garlic', 'Chilli'] } },
  { id: 'm26', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Fish Fry (2Pc)',             nameHi: 'फिश फ्राई (2 पीस)',         price: 109, emoji: '🐟', popular: false, tags: ['non-veg'], nutrition: { calories: 200, protein: 20, carbs:  8, fat: 10, ingredients: ['Fish', 'Turmeric', 'Chilli', 'Lemon Juice', 'Garlic', 'Ginger'] } },
  { id: 'm27', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Fish Fry (4Pc)',             nameHi: 'फिश फ्राई (4 पीस)',         price: 209, emoji: '🐟', popular: false, tags: ['non-veg'], nutrition: { calories: 400, protein: 40, carbs: 16, fat: 20, ingredients: ['Fish', 'Turmeric', 'Chilli', 'Lemon Juice', 'Garlic', 'Ginger'] } },
  { id: 'm28', category: 'Non-Veg Starters', categoryHi: 'नॉन-वेज स्टार्टर', name: 'Fish Fry (8Pc)',             nameHi: 'फिश फ्राई (8 पीस)',         price: 399, emoji: '🐟', popular: false, tags: ['non-veg'], nutrition: { calories: 800, protein: 80, carbs: 32, fat: 40, ingredients: ['Fish', 'Turmeric', 'Chilli', 'Lemon Juice', 'Garlic', 'Ginger'] } },

  // ─── Main Course Veg ───
  { id: 'm29', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Kadhai Paneer',            nameHi: 'कढ़ाई पनीर',                price: 109, emoji: '🫕', popular: true,  tags: ['veg'],     nutrition: { calories: 380, protein: 18, carbs: 16, fat: 28, ingredients: ['Paneer', 'Tomato', 'Onion', 'Capsicum', 'Kadhai Masala', 'Ginger'] } },
  { id: 'm30', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Matar Paneer',             nameHi: 'मटर पनीर',                  price: 109, emoji: '🫕', popular: false, tags: ['veg'],     nutrition: { calories: 360, protein: 16, carbs: 22, fat: 24, ingredients: ['Paneer', 'Green Peas', 'Tomato', 'Onion', 'Ginger', 'Cream'] } },
  { id: 'm31', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Mushroom Masala',          nameHi: 'मशरूम मसाला',               price: 129, emoji: '🍄', popular: false, tags: ['veg'],     nutrition: { calories: 220, protein:  8, carbs: 18, fat: 14, ingredients: ['Mushroom', 'Tomato', 'Onion', 'Ginger', 'Garlic', 'Spices'] } },
  { id: 'm32', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Chole Masala',             nameHi: 'छोले मसाला',                price: 99,  emoji: '🫘', popular: false, tags: ['veg'],     nutrition: { calories: 280, protein: 12, carbs: 38, fat: 10, ingredients: ['Chickpeas', 'Tomato', 'Onion', 'Ginger', 'Garlic', 'Chole Masala'] } },
  { id: 'm33', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Paneer Bhurji',            nameHi: 'पनीर भुर्जी',               price: 99,  emoji: '🧀', popular: false, tags: ['veg'],     nutrition: { calories: 350, protein: 18, carbs: 10, fat: 26, ingredients: ['Paneer', 'Onion', 'Tomato', 'Capsicum', 'Ginger', 'Spices'] } },
  ...
  { id: 'm35', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Aloo Chokha',              nameHi: 'आलू चोखा',                  price: 59,  emoji: '🥔', popular: false, tags: ['veg'],     nutrition: { calories: 180, protein:  4, carbs: 30, fat:  6, ingredients: ['Potato', 'Mustard Oil', 'Green Chilli', 'Onion', 'Garlic', 'Coriander'] } },
  { id: 'm36', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Aloo Baigan Tamatar Chokha', nameHi: 'आलू बैगन टमाटर चोखा',    price: 49,  emoji: '🍆', popular: false, tags: ['veg'],     nutrition: { calories: 160, protein:  4, carbs: 28, fat:  4, ingredients: ['Potato', 'Brinjal', 'Tomato', 'Mustard Oil', 'Green Chilli', 'Onion'] } },
  { id: 'm37', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Paneer Butter Masala',     nameHi: 'पनीर बटर मसाला',            price: 149, emoji: '🧈', popular: true,  tags: ['veg'],     nutrition: { calories: 420, protein: 18, carbs: 24, fat: 28, ingredients: ['Paneer', 'Tomato', 'Butter', 'Cream', 'Cashew', 'Cardamom'] } },
  { id: 'm38', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Paneer Makhani',           nameHi: 'पनीर मखनी',                 price: 149, emoji: '🫕', popular: true,  tags: ['veg'],     nutrition: { calories: 440, protein: 18, carbs: 22, fat: 30, ingredients: ['Paneer', 'Tomato', 'Butter', 'Cream', 'Fenugreek', 'Cardamom'] } },
  { id: 'm39', category: 'Main Course Veg',  categoryHi: 'मुख्य व्यंजन (वेज)', name: 'Veg Regular',              nameHi: 'वेज रेगुलर',                price: 69,  emoji: '🥗', popular: false, tags: ['veg'],     nutrition: { calories: 180, protein:  6, carbs: 22, fat:  8, ingredients: ['Mixed Vegetables', 'Onion', 'Tomato', 'Spices', 'Oil', 'Coriander'] } },

  // ─── Main Course Non-Veg ───
  { id: 'm40', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Chicken Curry (2Pc)',   nameHi: 'चिकन करी (2 पीस)',    price: 99,  emoji: '🍛', popular: false, tags: ['non-veg'], nutrition: { calories: 220, protein: 24, carbs:  8, fat: 12, ingredients: ['Chicken', 'Tomato', 'Onion', 'Ginger', 'Garlic', 'Spices'] } },
  { id: 'm41', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Chicken Curry (4Pc)',   nameHi: 'चिकन करी (4 पीस)',    price: 189, emoji: '🍛', popular: true,  tags: ['non-veg'], nutrition: { calories: 440, protein: 48, carbs: 16, fat: 24, ingredients: ['Chicken', 'Tomato', 'Onion', 'Ginger', 'Garlic', 'Spices'] } },
  { id: 'm42', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Chicken Curry (8Pc)',   nameHi: 'चिकन करी (8 पीस)',    price: 369, emoji: '🍛', popular: false, tags: ['non-veg'], nutrition: { calories: 880, protein: 96, carbs: 32, fat: 48, ingredients: ['Chicken', 'Tomato', 'Onion', 'Ginger', 'Garlic', 'Spices'] } },
  { id: 'm43', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Fish Curry (2Pc)',      nameHi: 'फिश करी (2 पीस)',     price: 139, emoji: '🐟', popular: false, tags: ['non-veg'], nutrition: { calories: 200, protein: 22, carbs:  8, fat: 10, ingredients: ['Fish', 'Tomato', 'Onion', 'Mustard', 'Turmeric', 'Coconut'] } },
  { id: 'm44', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Fish Curry (4Pc)',      nameHi: 'फिश करी (4 पीस)',     price: 269, emoji: '🐟', popular: false, tags: ['non-veg'], nutrition: { calories: 400, protein: 44, carbs: 16, fat: 20, ingredients: ['Fish', 'Tomato', 'Onion', 'Mustard', 'Turmeric', 'Coconut'] } },
  { id: 'm45', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Fish Curry (8Pc)',      nameHi: 'फिश करी (8 पीस)',     price: 519, emoji: '🐟', popular: false, tags: ['non-veg'], nutrition: { calories: 800, protein: 88, carbs: 32, fat: 40, ingredients: ['Fish', 'Tomato', 'Onion', 'Mustard', 'Turmeric', 'Coconut'] } },
  { id: 'm46', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Egg Bhurji (2Pc)',      nameHi: 'अंडा भुर्जी (2 पीस)', price: 49,  emoji: '🥚', popular: false, tags: ['non-veg'], nutrition: { calories: 160, protein: 12, carbs:  4, fat: 12, ingredients: ['Eggs', 'Onion', 'Tomato', 'Green Chilli', 'Spices', 'Oil'] } },
  { id: 'm47', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Egg Bhurji (4Pc)',      nameHi: 'अंडा भुर्जी (4 पीस)', price: 95,  emoji: '🥚', popular: false, tags: ['non-veg'], nutrition: { calories: 320, protein: 24, carbs:  8, fat: 24, ingredients: ['Eggs', 'Onion', 'Tomato', 'Green Chilli', 'Spices', 'Oil'] } },
  { id: 'm48', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Egg Bhurji (8Pc)',      nameHi: 'अंडा भुर्जी (8 पीस)', price: 189, emoji: '🥚', popular: false, tags: ['non-veg'], nutrition: { calories: 640, protein: 48, carbs: 16, fat: 48, ingredients: ['Eggs', 'Onion', 'Tomato', 'Green Chilli', 'Spices', 'Oil'] } },
  { id: 'm49', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Omelette (2Pc)',        nameHi: 'ऑमलेट (2 पीस)',       price: 49,  emoji: '🍳', popular: false, tags: ['non-veg'], nutrition: { calories: 180, protein: 14, carbs:  2, fat: 14, ingredients: ['Eggs', 'Onion', 'Green Chilli', 'Coriander', 'Salt', 'Oil'] } },
  { id: 'm50', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Omelette (4Pc)',        nameHi: 'ऑमलेट (4 पीस)',       price: 95,  emoji: '🍳', popular: false, tags: ['non-veg'], nutrition: { calories: 360, protein: 28, carbs:  4, fat: 28, ingredients: ['Eggs', 'Onion', 'Green Chilli', 'Coriander', 'Salt', 'Oil'] } },
  { id: 'm51', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Omelette (8Pc)',        nameHi: 'ऑमलेट (8 पीस)',       price: 189, emoji: '🍳', popular: false, tags: ['non-veg'], nutrition: { calories: 720, protein: 56, carbs:  8, fat: 56, ingredients: ['Eggs', 'Onion', 'Green Chilli', 'Coriander', 'Salt', 'Oil'] } },
  { id: 'm52', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Egg Curry (2Pc)',       nameHi: 'अंडा करी (2 पीस)',    price: 79,  emoji: '🥚', popular: false, tags: ['non-veg'], nutrition: { calories: 200, protein: 14, carbs: 10, fat: 12, ingredients: ['Eggs', 'Tomato', 'Onion', 'Ginger', 'Garlic', 'Spices'] } },
  { id: 'm53', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Egg Curry (4Pc)',       nameHi: 'अंडा करी (4 पीस)',    price: 149, emoji: '🥚', popular: false, tags: ['non-veg'], nutrition: { calories: 400, protein: 28, carbs: 20, fat: 24, ingredients: ['Eggs', 'Tomato', 'Onion', 'Ginger', 'Garlic', 'Spices'] } },
  { id: 'm54', category: 'Main Course Non-Veg', categoryHi: 'मुख्य व्यंजन (नॉन-वेज)', name: 'Egg Curry (8Pc)',       nameHi: 'अंडा करी (8 पीस)',    price: 289, emoji: '🥚', popular: false, tags: ['non-veg'], nutrition: { calories: 800, protein: 56, carbs: 40, fat: 48, ingredients: ['Eggs', 'Tomato', 'Onion', 'Ginger', 'Garlic', 'Spices'] } },
  ...
  { id: 'm61', category: 'Veg Meals',        categoryHi: 'वेज मील्स',          name: 'Dal Chawal Bhujiya',         nameHi: 'दाल चावल भुजिया',          price: 99,  emoji: '🍚', popular: false, tags: ['veg', 'meal'], nutrition: { calories: 480, protein: 14, carbs: 72, fat: 14, ingredients: ['Rice', 'Dal', 'Aloo Bhujiya', 'Salad', 'Pickle'] } },
  { id: 'm62', category: 'Veg Meals',        categoryHi: 'वेज मील्स',          name: 'Dal Chawal Chokha',          nameHi: 'दाल चावल चोखा',            price: 99,  emoji: '🍚', popular: false, tags: ['veg', 'meal'], nutrition: { calories: 460, protein: 14, carbs: 70, fat: 12, ingredients: ['Rice', 'Dal', 'Aloo Chokha', 'Salad', 'Pickle'] } },
  { id: 'm63', category: 'Veg Meals',        categoryHi: 'वेज मील्स',          name: 'Roti Sabzi Meal',            nameHi: 'रोटी सब्जी मील',           price: 99,  emoji: '🫓', popular: false, tags: ['veg', 'meal'], nutrition: { calories: 420, protein: 14, carbs: 62, fat: 14, ingredients: ['Roti', 'Sabzi', 'Dal', 'Salad', 'Pickle'] } },
  ...
  { id: 'm66', category: 'Veg Meals',        categoryHi: 'वेज मील्स',          name: 'Dal Khichdi',                nameHi: 'दाल खिचड़ी',               price: 99,  emoji: '🍚', popular: false, tags: ['veg', 'meal'], nutrition: { calories: 400, protein: 14, carbs: 64, fat: 12, ingredients: ['Rice', 'Moong Dal', 'Ghee', 'Turmeric', 'Cumin', 'Ginger'] } },

  // ─── Non-Veg Meals ───
  { id: 'm67', category: 'Non-Veg Meals',    categoryHi: 'नॉन-वेज मील्स',     name: 'Chicken Plain Rice Meal',    nameHi: 'चिकन प्लेन राइस मील',     price: 189, emoji: '🍱', popular: true,  tags: ['non-veg', 'meal'], nutrition: { calories: 620, protein: 36, carbs: 70, fat: 20, ingredients: ['Chicken Curry', 'Rice', 'Dal', 'Salad', 'Pickle', 'Papad'] } },
  { id: 'm68', category: 'Non-Veg Meals',    categoryHi: 'नॉन-वेज मील्स',     name: 'Chicken Jeera Rice Meal',    nameHi: 'चिकन जीरा राइस मील',      price: 199, emoji: '🍱', popular: false, tags: ['non-veg', 'meal'], nutrition: { calories: 650, protein: 36, carbs: 74, fat: 22, ingredients: ['Chicken Curry', 'Jeera Rice', 'Dal', 'Salad', 'Pickle', 'Papad'] } },
  { id: 'm69', category: 'Non-Veg Meals',    categoryHi: 'नॉन-वेज मील्स',     name: 'Chicken Pulav Meal',         nameHi: 'चिकन पुलाव मील',           price: 209, emoji: '🍱', popular: false, tags: ['non-veg', 'meal'], nutrition: { calories: 660, protein: 36, carbs: 78, fat: 22, ingredients: ['Chicken Curry', 'Pulav', 'Raita', 'Salad', 'Papad'] } },
  { id: 'm70', category: 'Non-Veg Meals',    categoryHi: 'नॉन-वेज मील्स',     name: 'Roti Chicken Meal',          nameHi: 'रोटी चिकन मील',            price: 189, emoji: '🫓', popular: false, tags: ['non-veg', 'meal'], nutrition: { calories: 580, protein: 38, carbs: 58, fat: 22, ingredients: ['Chicken Curry', 'Roti', 'Dal', 'Salad', 'Pickle'] } },
  { id: 'm71', category: 'Non-Veg Meals',    categoryHi: 'नॉन-वेज मील्स',     name: 'Fish Thali',                 nameHi: 'फिश थाली',                 price: 199, emoji: '🐟', popular: false, tags: ['non-veg', 'meal'], nutrition: { calories: 640, protein: 34, carbs: 72, fat: 22, ingredients: ['Fish Curry', 'Rice', 'Dal', 'Salad', 'Pickle', 'Papad'] } },

  // ─── Rice & Biryani ───
  { id: 'm72', category: 'Rice & Biryani',   categoryHi: 'चावल और बिरयानी',   name: 'Plain Rice (Half)',          nameHi: 'प्लेन राइस (हाफ)',         price: 45,  emoji: '🍚', popular: false, tags: ['veg'],     nutrition: { calories: 180, protein:  4, carbs: 40, fat:  0, ingredients: ['Basmati Rice', 'Water', 'Salt'] } },
  ...
  { id: 'm74', category: 'Rice & Biryani',   categoryHi: 'चावल और बिरयानी',   name: 'Jeera Rice (Half)',          nameHi: 'जीरा राइस (हाफ)',          price: 65,  emoji: '🍚', popular: false, tags: ['veg'],     nutrition: { calories: 200, protein:  4, carbs: 42, fat:  4, ingredients: ['Basmati Rice', 'Cumin', 'Ghee', 'Salt', 'Bay Leaf'] } },
  ...
  { id: 'm80', category: 'Rice & Biryani',   categoryHi: 'चावल और बिरयानी',   name: 'Veg Biryani',               nameHi: 'वेज बिरयानी',               price: 139, emoji: '🍲', popular: false, tags: ['veg'],     nutrition: { calories: 380, protein: 10, carbs: 58, fat: 12, ingredients: ['Basmati Rice', 'Mixed Vegetables', 'Saffron', 'Fried Onions', 'Whole Spices', 'Ghee'] } },
  { id: 'm81', category: 'Rice & Biryani',   categoryHi: 'चावल और बिरयानी',   name: 'Chicken Biryani',           nameHi: 'चिकन बिरयानी',              price: 159, emoji: '🍲', popular: true,  tags: ['non-veg'], nutrition: { calories: 560, protein: 38, carbs: 62, fat: 18, ingredients: ['Basmati Rice', 'Chicken', 'Saffron', 'Fried Onions', 'Yogurt', 'Whole Spices'] } },
  ...
  { id: 'm83', category: 'Rice & Biryani',   categoryHi: 'चावल और बिरयानी',   name: 'Veg Fried Rice',            nameHi: 'वेज फ्राइड राइस',          price: 129, emoji: '🍚', popular: false, tags: ['veg'],     nutrition: { calories: 380, protein:  8, carbs: 66, fat: 10, ingredients: ['Rice', 'Mixed Vegetables', 'Soy Sauce', 'Garlic', 'Spring Onion', 'Oil'] } },
  ...
  { id: 'm87', category: 'Rice & Biryani',   categoryHi: 'चावल और बिरयानी',   name: 'Chicken Fried Rice',        nameHi: 'चिकन फ्राइड राइस',         price: 159, emoji: '🍗', popular: false, tags: ['non-veg'], nutrition: { calories: 460, protein: 24, carbs: 64, fat: 14, ingredients: ['Rice', 'Chicken', 'Soy Sauce', 'Garlic', 'Spring Onion', 'Egg'] } },
  { id: 'm88', category: 'Rice & Biryani',   categoryHi: 'चावल और बिरयानी',   name: 'Chicken Schezwan Fried Rice', nameHi: 'चिकन शेजवान फ्राइड राइस', price: 169, emoji: '🌶️', popular: false, tags: ['non-veg'], nutrition: { calories: 480, protein: 24, carbs: 66, fat: 16, ingredients: ['Rice', 'Chicken', 'Schezwan Sauce', 'Garlic', 'Spring Onion', 'Capsicum'] } },

  // ─── Noodles ───
  { id: 'm89', category: 'Noodles',          categoryHi: 'नूडल्स',             name: 'Veg Noodles',               nameHi: 'वेज नूडल्स',                price: 129, emoji: '🍜', popular: false, tags: ['veg'],     nutrition: { calories: 360, protein:  8, carbs: 64, fat:  8, ingredients: ['Noodles', 'Mixed Vegetables', 'Soy Sauce', 'Garlic', 'Spring Onion', 'Oil'] } },
  ...
  { id: 'm91', category: 'Noodles',          categoryHi: 'नूडल्स',             name: 'Paneer Noodles',            nameHi: 'पनीर नूडल्स',               price: 149, emoji: '🧀', popular: false, tags: ['veg'],     nutrition: { calories: 420, protein: 16, carbs: 64, fat: 14, ingredients: ['Noodles', 'Paneer', 'Soy Sauce', 'Garlic', 'Spring Onion', 'Capsicum'] } },
  ...
  { id: 'm93', category: 'Noodles',          categoryHi: 'नूडल्स',             name: 'Chicken Noodles',           nameHi: 'चिकन नूडल्स',               price: 159, emoji: '🍗', popular: false, tags: ['non-veg'], nutrition: { calories: 420, protein: 24, carbs: 60, fat: 14, ingredients: ['Noodles', 'Chicken', 'Soy Sauce', 'Garlic', 'Spring Onion', 'Egg'] } },
  { id: 'm94', category: 'Noodles',          categoryHi: 'नूडल्स',             name: 'Chicken Schezwan Noodles',  nameHi: 'चिकन शेजवान नूडल्स',        price: 169, emoji: '🌶️', popular: true,  tags: ['non-veg'], nutrition: { calories: 440, protein: 24, carbs: 62, fat: 16, ingredients: ['Noodles', 'Chicken', 'Schezwan Sauce', 'Garlic', 'Chilli', 'Spring Onion'] } },

  // ─── Roti & Paratha ───
  { id: 'm95',  category: 'Roti & Paratha',  categoryHi: 'रोटी और पराठा',     name: 'Plain Roti',                nameHi: 'प्लेन रोटी',                price: 10,  emoji: '🫓', popular: false, tags: ['veg'],     nutrition: { calories:  80, protein:  3, carbs: 16, fat:  1, ingredients: ['Whole Wheat Flour', 'Water', 'Salt'] } },
  { id: 'm96',  category: 'Roti & Paratha',  categoryHi: 'रोटी और पराठा',     name: 'Ghee Roti',                 nameHi: 'घी रोटी',                   price: 15,  emoji: '🫓', popular: false, tags: ['veg'],     nutrition: { calories: 110, protein:  3, carbs: 16, fat:  4, ingredients: ['Whole Wheat Flour', 'Ghee', 'Water', 'Salt'] } },
  { id: 'm97',  category: 'Roti & Paratha',  categoryHi: 'रोटी और पराठा',     name: 'Butter Roti',               nameHi: 'बटर रोटी',                  price: 12,  emoji: '🧈', popular: false, tags: ['veg'],     nutrition: { calories: 100, protein:  3, carbs: 16, fat:  3, ingredients: ['Whole Wheat Flour', 'Butter', 'Water', 'Salt'] } },
  { id: 'm98',  category: 'Roti & Paratha',  categoryHi: 'रोटी और पराठा',     name: 'Plain Paratha',             nameHi: 'प्लेन पराठा',               price: 25,  emoji: '🫓', popular: false, tags: ['veg'],     nutrition: { calories: 180, protein:  4, carbs: 28, fat:  6, ingredients: ['Whole Wheat Flour', 'Oil', 'Water', 'Salt'] } },
  ...
  { id: 'm100', category: 'Roti & Paratha',  categoryHi: 'रोटी और पराठा',     name: 'Sattu Paratha',             nameHi: 'सत्तू पराठा',               price: 55,  emoji: '🫓', popular: false, tags: ['veg'],     nutrition: { calories: 260, protein: 10, carbs: 34, fat: 10, ingredients: ['Whole Wheat Flour', 'Sattu', 'Onion', 'Green Chilli', 'Mustard Oil', 'Coriander'] } },
  ...
  { id: 'm103', category: 'Roti & Paratha',  categoryHi: 'रोटी और पराठा',     name: 'Paneer Paratha',            nameHi: 'पनीर पराठा',                price: 70,  emoji: '🧀', popular: false, tags: ['veg'],     nutrition: { calories: 300, protein: 12, carbs: 32, fat: 14, ingredients: ['Whole Wheat Flour', 'Paneer', 'Green Chilli', 'Coriander', 'Spices', 'Oil'] } },

  // ─── Dal ───
  { id: 'm104', category: 'Dal',             categoryHi: 'दाल',               name: 'Dal Fry (Half)',            nameHi: 'दाल फ्राई (हाफ)',           price: 50,  emoji: '🫘', popular: false, tags: ['veg'],     nutrition: { calories: 150, protein:  8, carbs: 22, fat:  4, ingredients: ['Yellow Lentils', 'Onion', 'Tomato', 'Garlic', 'Cumin', 'Ghee'] } },
  { id: 'm105', category: 'Dal',             categoryHi: 'दाल',               name: 'Dal Fry (Full)',            nameHi: 'दाल फ्राई (फुल)',           price: 90,  emoji: '🫘', popular: false, tags: ['veg'],     nutrition: { calories: 300, protein: 16, carbs: 44, fat:  8, ingredients: ['Yellow Lentils', 'Onion', 'Tomato', 'Garlic', 'Cumin', 'Ghee'] } },
  { id: 'm106', category: 'Dal',             categoryHi: 'दाल',               name: 'Dal Tadka (Half)',          nameHi: 'दाल तड़का (हाफ)',           price: 70,  emoji: '🫘', popular: true,  tags: ['veg'],     nutrition: { calories: 170, protein:  8, carbs: 24, fat:  6, ingredients: ['Arhar Dal', 'Garlic', 'Cumin', 'Dried Red Chilli', 'Ghee', 'Tomato'] } },
  { id: 'm107', category: 'Dal',             categoryHi: 'दाल',               name: 'Dal Tadka (Full)',          nameHi: 'दाल तड़का (फुल)',           price: 120, emoji: '🫘', popular: true,  tags: ['veg'],     nutrition: { calories: 340, protein: 16, carbs: 48, fat: 12, ingredients: ['Arhar Dal', 'Garlic', 'Cumin', 'Dried Red Chilli', 'Ghee', 'Tomato'] } },

  // ─── Beverages ───
  { id: 'm108', category: 'Beverages',       categoryHi: 'पेय',               name: 'Lassi',                     nameHi: 'लस्सी',                    price: 60,  emoji: '🥛', popular: true,  tags: ['veg'],     nutrition: { calories: 180, protein:  6, carbs: 28, fat:  6, ingredients: ['Yogurt', 'Sugar', 'Cardamom', 'Rose Water', 'Milk'] } },
  { id: 'm109', category: 'Beverages',       categoryHi: 'पेय',               name: 'Sattu',                     nameHi: 'सत्तू',                    price: 40,  emoji: '🥤', popular: false, tags: ['veg'],     nutrition: { calories: 160, protein:  8, carbs: 26, fat:  2, ingredients: ['Roasted Gram Flour', 'Water', 'Lemon', 'Black Salt', 'Cumin'] } },
  ...
  { id: 'm111', category: 'Beverages',       categoryHi: 'पेय',               name: 'Mineral Water',             nameHi: 'मिनरल वाटर',               price: 20,  emoji: '💧', popular: false, tags: ['veg'],     nutrition: { calories:   0, protein:  0, carbs:  0, fat:  0, ingredients: ['Purified Water'] } },
];
